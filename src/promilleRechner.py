...
sortPerson = input("Ist die Person jugendlich (j), erwachsen und männlich (m) oder erwachsen und weiblich (w)? [eigene Reduktionsfaktoreingabe auch möglich]\n")
...
#output
print(f"Die errechnete Blutalkoholkonzentration beträgt ungefähr {round(bloodAlcohol, 2)} Promille")
